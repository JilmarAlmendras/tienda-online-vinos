...
const HeaderSlider = () => {
  const sliderData = [
    {
      id: 1,
      title: "Descubre el Sabor Perfecto - Tu Vino Ideal Te Espera",
    ...
    {
      id: 2,
      title: "Siente la Pasión del Vino - Colecciones Exclusivas",
    ...
    {
      id: 3,
      title: "Elegancia y Sabor - El Vino que Mereces Está Aquí",
