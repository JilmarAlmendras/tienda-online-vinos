...
import header_vino_blanco from "./header_vino_blanco.png";
import header_botella_vino from "./header_botella_vino.png";
import header_vino_tinto from "./header_vino_tinto.png";
import macbook_image from "./macbook_image.png";
import bose_headphone_image from "./bose_headphone_image.png";
import vino_uno from "./vino_uno.png";
...
import vino_blanco_banner_image from "./vino_blanco_banner_image.png";
import vino_tino_banner_image from "./vino_tino_banner_image.png";
import campo_uvas from "./campo_uvas.png";
import sm_controller_image from "./sm_controller_image.png";
import copa_vino from "./copa_vino.png";
import vino_banner_image from "./vino_banner_image.png";
...
export const assets = {
  ...
  projector_image,
  playstation_image,
  vino_blanco_banner_image,
  vino_tino_banner_image,
  campo_uvas,
  sm_controller_image,
  copa_vino,
  vino_banner_image,
...
export const productsDummyData = [
  {
    ...
    description:
      "Un vino tinto intenso con notas a frutas rojas maduras, roble tostado y especias. Ideal para carnes rojas y quesos curados.",
    price: 349,
    offerPrice: 299,
    image: [
  ...
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    name: "Vino Blanco Chardonnay Premium",
    description:
      "Vino blanco seco con toques cítricos, manzana verde y sutiles notas de vainilla. Perfecto para maridar con pescados y mariscos.",
    price: 329,
    offerPrice: 279,
    image: [
  ...
  },
  {
    ...
    description:
      "Malbec de cuerpo completo, con aromas a ciruela, chocolate amargo y un final suave y persistente.",
    price: 399,
    offerPrice: 349,
    image: [
  ...
  },
  {
    ...
    description:
      "Refrescante y ligero, este Sauvignon Blanc presenta notas herbales, cítricas y un final mineral. Ideal para días cálidos.",
    price: 309,
    offerPrice: 259,
    image: [
  ...
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    name: "Blend Tinto Roble",
    description:
      "Exquisito blend de uvas tintas envejecido en barricas de roble. Sabor redondo con taninos suaves y persistente aroma a frutos negros.",
    price: 459,
    offerPrice: 399,
    image: [
  ...
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    name: "Chardonnay Reserva Especial",
    description:
      "Chardonnay elegante con paso por barrica, de textura cremosa y notas a frutas tropicales con un toque de mantequilla.",
    price: 379,
    offerPrice: 329,
    image: [
  ...
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    name: "Syrah Roble Intenso",
    description:
      "Un vino de gran intensidad y carácter. Notas a mora, café y pimienta negra. Ideal para platos intensos y quesos fuertes.",
    price: 499,
    offerPrice: 449,
    image: [
  ...
  },
  {
    ...
    userId: "user_2sZFHS1UIIysJyDVzCpQhUhTIhw",
    name: "Vino Blanco Dulce Natural",
    description:
      "Blanco dulce con notas florales y frutales como durazno y miel. Ideal para postres o disfrutar solo, bien frío.",
    price: 279,
    offerPrice: 239,
    image: [
  ...
  },
  {
    ...
    description:
      "Un Cabernet Franc elegante con taninos finos, equilibrado y notas a pimiento rojo asado y frutos silvestres.",
    price: 389,
    offerPrice: 339,
    image: [
  ...
  },
  {
    ...
    description:
      "Vino blanco fresco y perfumado con aromas a flor de azahar, pera y cítricos. Ligero y refrescante.",
    price: 319,
    offerPrice: 289,
    image: [
